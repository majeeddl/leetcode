...
class TestWordSearch(unittest.TestCase,Solution):
    ...
    def test_one(self):
        self.assertEqual(self.exist([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]],"ABCCED"),True,"Should be true")
    ...
    def test_three(self):
        self.assertEqual(self.exist([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]],"ABCB"),False,"Should be false")